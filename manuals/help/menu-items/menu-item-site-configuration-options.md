---
sidebar_position: 34
id: menu-item-site-configuration-options
...
alt="Help-4x-Menus-Menu-Display Configuration-screenshot-en.png" />
...
alt="Help-4x-Menus-Menu-Display Configuration-front-end-screenshot-en.png" />
