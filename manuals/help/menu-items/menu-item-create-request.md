---
sidebar_position: 10
id: menu-item-create-request
title: "Help4.x:Menu Item: Create Request"
---
## Description

The **Create Request** menu item type is used to display a form allowing
users to submit an information request (Export or Remove).

## How To Access

To create a new **Create Request** menu item:
...
- Select **Menus **→** \[name of the menu\]** from the Administrator
  ...
  - In the modal dialog select the Privacy item to open a list and then
    select the **Create Request** item.

To edit an existing Create Reques menu item:
...
<img
src="https://docs.joomla.org/images/0/04/Help-4x-Menus-Menu-Item-Privacy-Create-Request-screen-en.png"
decoding="async" data-file-width="800" data-file-height="812"
width="800" height="812"
alt="Help-4x-Menus-Menu-Item-Privacy-Create-Request-screen-en.png" />
