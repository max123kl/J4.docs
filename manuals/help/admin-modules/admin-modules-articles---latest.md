---
sidebar_position: 4
id: admin-modules-articles---latest
title: "Help4.x:Admin Modules: Articles - Latest"
---
## Description

The **Articles - Latest** Module type is used to display the "Recently
...
<img
src="https://docs.joomla.org/images/thumb/8/8f/Help-4x-modules-administrator-module-manager-articles-latest-en.png/800px-Help-4x-modules-administrator-module-manager-articles-latest-en.png"
decoding="async"
srcset="https://docs.joomla.org/images/thumb/8/8f/Help-4x-modules-administrator-module-manager-articles-latest-en.png/1200px-Help-4x-modules-administrator-module-manager-articles-latest-en.png 1.5x, https://docs.joomla.org/images/8/8f/Help-4x-modules-administrator-module-manager-articles-latest-en.png 2x"
data-file-width="1440" data-file-height="1218" width="800" height="677"
alt="Help-4x-modules-administrator-module-manager-articles-latest-en.png" />
...
- **Order.** (*Recently Added First*/*Recently Modified First*) Ordering
  options.
- **Category.** (*Any Category*/...) Select Articles from a specific
  Category or all Categories.
- **Authors.** (*Anyone*/*Added or modified by me*/*Not added or
  modified by me*) A filter for the authors.
