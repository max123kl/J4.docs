---
sidebar_position: 22
id: admin-modules-user-menu
title: "Help4.x:Admin Modules: User Menu"
---
## Description

This module shows the User Menu in the Administrator Title Bar <img
src="https://docs.joomla.org/images/3/3d/Help-4x-modules-administrator-module-user-menu-icon-en.png"
decoding="async" data-file-width="91" data-file-height="49" width="91"
height="49"
alt="Help-4x-modules-administrator-module-user-menu-icon-en.png" />
...
<img
src="https://docs.joomla.org/images/d/db/Help-4x-modules-administrator-module-user-menu-en.png"
decoding="async" data-file-width="800" data-file-height="713"
width="800" height="713"
alt="Help-4x-modules-administrator-module-user-menu-en.png" />
...
- **Information.** This module shows the User Menu.
