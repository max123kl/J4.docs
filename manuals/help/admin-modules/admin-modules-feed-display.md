---
sidebar_position: 6
id: admin-modules-feed-display
title: "Help4.x:Admin Modules: Feed Display"
---
## Description
...
<img
src="https://docs.joomla.org/images/8/85/Help-4x-modules-administrator-module-manager-module-feed-display-en.png"
decoding="async" data-file-width="800" data-file-height="699"
width="800" height="699"
alt="Help-4x-modules-administrator-module-manager-module-feed-display-en.png" />
...
- **Feed Date.** (*Yes*/*No*). Display news feed date.
...
An example News Feed is shown below:
