---
sidebar_position: 9
id: admin-modules-logged-in-users
title: "Help4.x:Admin Modules: Logged-in Users"
---
## Description

The **Logged-in Users** module type shows a list of users who are
currently logged into the site. This is displayed in the Control Panel.
...
<img
src="https://docs.joomla.org/images/e/ec/Help-4x-modules-administrator-module-manager-logged-in-users-en.png"
decoding="async" data-file-width="800" data-file-height="638"
width="800" height="638"
alt="Help-4x-modules-administrator-module-manager-logged-in-users-en.png" />
...
- **Users to Display.** The number of items to display (default 5).
- **Name.** (*Name*/*Username*) Displays name or username.
