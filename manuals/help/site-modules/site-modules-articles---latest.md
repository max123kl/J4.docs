---
sidebar_position: 4
id: site-modules-articles---latest
title: "Help4.x:Site Modules: Articles - Latest"
---
## Description
...
<img
src="https://docs.joomla.org/images/d/dc/Help-4x-modules-site-module-manager-module-articles-latest-en.png"
decoding="async" data-file-width="800" data-file-height="753"
width="800" height="753"
alt="Help-4x-modules-site-module-manager-module-articles-latest-en.png" />
...
- **Category:** Selects Articles from one or more Categories. If no
...
- **Order:** (*Recently Added First*/*Recently Modified First*/*Recently
  Published First*/*Recently Touched First*/*Random Articles*). Recently
  Added First: order the articles using their creation dateRecently
  Modified First: order the articles using their modification
  dateRecently Published First: order the articles using their
  publication date.Recently Touched First: order the articles using
  their modification or creation dates.
- **Authors:** (*Anyone*/*Added or modified by me*/*Not added or
  modified by me*). Filter by author.
...
<img
src="https://docs.joomla.org/images/3/38/Help-4x-Extensions-Module-Manager-Articles-Latest-example-output-en.png"
decoding="async" data-file-width="270" data-file-height="207"
width="270" height="207"
alt="Help-4x-Extensions-Module-Manager-Articles-Latest-example-output-en.png" />

The Module Type name for this is "mod_articles_latest". It is not
