...
title: "Help4.x:Site Modules: Syndication Feeds"
---
## Description
...
- **Label:** If 'Display Label' is activated, the text entered here will
  ...
  language ini file.
- **Display Label:** (*Yes*/*No*). If set to 'Yes', Label will be
  displayed next to the icon.
- **Feed Format:** (*RSS 2.0*/*Atom 1.0*). Select the format for the
  Syndication Feed.
...
Not all menu items types actually provide for an RSS feed. This will be
displayed on types of Category Blog and on Featured Articles menu types
(probably others). On pages for which no feed is available this module
will not display.

## Frontend View

An example Syndication module is shown below:
