---
sidebar_position: 22
id: site-modules-tags---similar
title: "Help4.x:Site Modules: Tags - Similar"
---
## Description
...
alt="Help-4x-modules-site-module-manager-module-similar-tags-en.png" />
...
- **Maximum items:** (*1*/*2*/*3*/*4*/*5*/*6*/*7*/...). Maximum number
  of items to display.
- **Match type:** (*All*/*Any*/*Half*). How closely an item's tags need
