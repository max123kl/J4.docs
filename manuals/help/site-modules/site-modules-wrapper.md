---
sidebar_position: 24
id: site-modules-wrapper
title: "Help4.x:Site Modules: Wrapper"
---
## Description
...
<img
src="https://docs.joomla.org/images/7/7c/Help-4x-modules-site-module-manager-module-wrapper-en.png"
decoding="async" data-file-width="800" data-file-height="676"
width="800" height="676"
alt="Help-4x-modules-site-module-manager-module-wrapper-en.png" />
...
- **Auto Add:** (*Yes*/*No*). By default, http:// will be added unless
  it detects http:// or https:// in the URL you provide. This allows you
  to switch this ability off.
- **Scroll Bars:** (*Auto*/*No*/*Yes*). Show/Hide Horizontal & Vertical
  Scroll Bars.
...
- **Auto Height:** (*Yes*/*No*). The height will automatically be set to
  the size of the external page. This will only work for pages on your
  own domain.
- **Frame border:** (*Yes*/*No*). Show frame border which wraps the
  iframe.
...
No tips have been added for the Wrapper module. The module type is
**mod_wrapper**.
